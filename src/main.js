 ...
 */
export async function readline(input, encoding = "utf-8", controller = undefined) {
 ...
 * @returns {Array[AbortController, AsyncGenerator]}
 */
export async function readline_forwards(input, encoding = "utf-8", controller = undefined) {
    controller = controller instanceof AbortController ? controller : new AbortController();
 ...
 * @returns {Array[AbortController, AsyncGenerator]}
 */
export async function readline_backwards(input, encoding = "utf-8", controller = undefined) {
    controller = controller instanceof AbortController ? controller : new AbortController();
...
export const readline_around = internal_readline_around.bind(null, readline)
export const readline_around_forwards = internal_readline_around.bind(null, readline_forwards)
export const readline_around_backwards = internal_readline_around.bind(null, readline_backwards)
